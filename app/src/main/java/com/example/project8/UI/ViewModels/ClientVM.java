...
public class ClientVM extends AndroidViewModel {
    ...
    private final com.example.project8.data.DataSources.Room.ClientRepository mRepository;

    public ClientVM(Application application) {
        super(application);
        Log.d("ClientVM", "Constructor");
        mRepository = new com.example.project8.data.DataSources.Room.ClientRepository(application);
